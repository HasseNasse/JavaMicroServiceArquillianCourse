...
import component.arquilliancourse.helloservice.specializations.GreetingDAOFindingObjectByIDSpecialization;
...
public class GreetingServiceFindingByIdTest extends AbstractTest {
    ...
    public static WebArchive createDeployment () {
        return createBasicDeployment()
                .addClasses(
                    ...
                    //Specializations
                    GreetingDAOFindingObjectByIDSpecialization.class
                ).addClasses(
                    //Data
